...
public class GetCourseInfo implements ApiRequest{
    ...
    public Object getData() {
        ...
        Object result = restTemplate.getForObject("https://www.sydney.edu.au/courses/units-of-study/2022/"+coursePrefix+"/"+coursePrefix+courseCode+".coredata.json",String.class);
        if (result==null)
            result = "";
        return result;
    }
